...
import styles from "../../../components/community/CommunityWriting.module.css";

const TipsCommuEdit = () => {

  const location = useLocation();
  const tipBoardId = location.state.tipBoardId;
  ...
  const onSubmitForm = (e: { preventDefault: () => void; }) => {
    ...
    .then((res) => {
      if(res.data.isSuccess) {
        ...
        window.location.replace(`/community/tips/${tipBoardId}`);
      }
      else {
        alert(res.data.message);
      }
